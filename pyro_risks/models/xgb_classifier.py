...
class PyronearXGBoostClassifier(XGBClassifier):
    """
    XGBoost Classifier for fire classification using weather data and historical wildfires.

    This classifier can be useful when using either:
    - NOAA weather data and BDIFF wildfire history
    - NOAA weather data and NASA FIRMS
    - ERA5 Land data and NASA FIRMS
    """
