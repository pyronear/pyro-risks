...
SELECTED_DEP = ['Pyrénées-Atlantiques', 'Hautes-Pyrénées', 'Ariège', 'Haute-Corse',
                'Lozère', 'Gard', 'Hérault', 'Bouches-du-Rhônes', 'Pyrénées-Orientales',
                'Cantal', 'Alpes-Maritimes', 'Aveyron']
